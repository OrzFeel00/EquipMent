...
import com.yc.tc.equipment.validation.validator.macvalidForString;
...
@Constraint(validatedBy = { macvalidForString.class})//这里写实现类，可以是多个，实现ConstraintValidator接口

public @interface macvalid {
	
	String message() default "必须是mac格式，用-或:隔开";
