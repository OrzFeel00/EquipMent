...
public class Devops implements Serializable{
	...
	//相机更换时间
	@NotEmpty(message = "不能为空")
	private String cameraReplacementTime;
	//运维负责人
	@NotEmpty(message = "不能为空")
	...
	public Devops(Integer devopsId, @NotEmpty(message = "不能为空") String ownership,
			...
			@NotEmpty(message = "不能为空") int warrantyPeriod, @NotEmpty(message = "不能为空") String cameraReplacementTime,
			@NotEmpty(message = "不能为空") String devopsLiable, @NotEmpty(message = "不能为空") String devopsPhone,
			Integer projectId, Integer equipmentId) {
		super();
	...
	public String getCameraReplacementTime() {
		return cameraReplacementTime;
	}

	public void setCameraReplacementTime(String cameraReplacementTime) {
		this.cameraReplacementTime = cameraReplacementTime;
	}
